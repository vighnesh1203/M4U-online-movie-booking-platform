...
<title>ShowList Admin Dashboard</title>
...
<body>
	...
	<section id="all-movies" class="mh-80 my-5 bg-light">
		<div class="container p-md-5">
			<h2 class="display-5 fw-600 text-center mt-3">Shows List</h2>
			<div class="movies-list my-4">
				<table class="table table-striped">
					...
					<c:forEach var="a" items="${sList}">
						<tr>
							<td>${a.theatre.theatreName}</td>
							<td>${a.theatre.theatreCity}</td>
							<td>${a.movie.movieName}</td>
							<td>${a.shTime}</td>
							<td>${a.showDate}</td>
							<td>${a.costOfTicket}</td>
 							<td> 
								<div style="display:none" class="d-flex align-items-center justify-content-center">
									
									<form action="deleteShowMapping" 
										class="btn btn-danger fw-700 text-white">
										<input type="text" value="${a.shId}" style="display: none"
											name="shId"> <input type="text" style="display:none" value="${a.theatre.theatreName}" name="theatreName">
											<input type="text" style="display:none" value="${a.movie.movieName}" name="movieName">
											<input type="submit"
											style="background-color: red; color: white; outline: none; border: none;"
											value="Delete">
									</form>
								</div>
							</td>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="addShow" class="modal-input-form">
						<div class="mb-3 d-flex">
							<label for="theatre-name" class="form-label my-auto fw-500">
								Theatre Name</label> <input required type="text" class="form-control"
								id="show-name" placeholder="Enter Theatre name"
								name="theatreName" />
						</div>
						<div class="mb-3 d-flex">
							<label for="inputCity class="form-label my-auto fw-500">
